(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppliedJobsComponent = /** @class */ (function () {
                function AppliedJobsComponent(jobService, router) {
                ...
                AppliedJobsComponent.prototype.getAppliedJobs = function () {
                    var _this = this;
                    this.httpErr = false;
                    this.jobService.getAppliedJobs(this.paginateObj.page).subscribe(function (res) {
                        _this.jobs = res.data;
                        _this.paginateObj.totalItem = res.meta.pagination.total;
                        if (_this.jobs.length == 0) {
                            _this.noJobsErr = true;
                            _this.errMsg = "Sorry, you haven't applied to any jobs";
                        }
                        else {
                            _this.noJobsErr = false;
                            _this.jobs = res.data;
                        }
                    }, function (err) {
                        _this.httpErr = true;
                        _this.httpErrMsg = err.error.message;
                    });
                };
                AppliedJobsComponent.prototype.pageChange = function () {
                    this.getAppliedJobs();
                };
                return AppliedJobsComponent;
            }());
            AppliedJobsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AvailableJobsComponent = /** @class */ (function () {
                function AvailableJobsComponent(jobService) {
                    this.jobService = jobService;
                    this.index = 0;
                    this.nojobsErr = false;
                    this.httpErr = false;
                ...
                AvailableJobsComponent.prototype.availableJobs = function () {
                    var _this = this;
                    this.jobService.availableJobs(this.paginateObj.page).subscribe(function (res) {
                        _this.nojobsErr = false;
                        _this.httpErr = false;
                        _this.jobs = res.data;
                        _this.paginateObj.totalItem = res.meta.pagination.total;
                ...
                AvailableJobsComponent.prototype.apply = function (uuid) {
                    var _this = this;
                    if (confirm("Do you really wish to apply ? ")) {
                        this.jobService.apply(uuid).subscribe(function (data) {
                            _this.availableJobs();
                        }, function (err) {
                            _this.httpErr = true;
                            _this.httpErrMsg = err.error.message;
                ...
                AvailableJobsComponent.prototype.pageChange = function () {
                    this.availableJobs();
                };
                return AvailableJobsComponent;
            }());
            AvailableJobsComponent.ctorParameters = function () { return [
                { type: _Services_jobs_jobs_service__WEBPACK_IMPORTED_MODULE_2__["JobService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PageNotFound404Component = /** @class */ (function () {
                function PageNotFound404Component() {
                }
                PageNotFound404Component.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostJobComponent = /** @class */ (function () {
                function PostJobComponent(jobService) {
                    this.jobService = jobService;
                ...
                PostJobComponent.prototype.postJob = function () {
                    var _this = this;
                    this.jobService.postJob(this.newJob).subscribe(function (data) {
                        _this.postedFlag = true;
                        _this.notPostedFlag = false;
                        _this.jobSuccessMsg = "Your Job was Successfully Posted";
                    }, function (err) {
                        _this.postedFlag = false;
                        _this.notPostedFlag = true;
                        _this.jobErrorMsg = err.error.message;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _Services_jobs_jobs_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../Services/jobs/jobs.service */ "./src/app/Services/jobs/jobs.service.ts");
            /* harmony import */ var _Models_job_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../Models/job.model */ "./src/app/Models/job.model.ts");
            var PostedJobsComponent = /** @class */ (function () {
                function PostedJobsComponent(jobService) {
                    this.jobService = jobService;
                    this.paginateObj = new _Models_job_model__WEBPACK_IMPORTED_MODULE_3__["paginateModel"]();
                ...
                PostedJobsComponent.prototype.getPostedJobs = function () {
                    var _this = this;
                    this.jobService.getPostedJobs(this.paginateObj.page).subscribe(function (res) {
                        _this.httpErr = false;
                        _this.jobs = res.data;
                        _this.paginateObj.totalItem = res.meta.pagination.total;
                        if (_this.jobs.length == 0) {
                ...
                PostedJobsComponent.prototype.applications = function (uuid) {
                    var _this = this;
                    this.jobService.getApplicants(uuid).subscribe(function (res) {
                        _this.noApplicantsFlag = false;
                        _this.applicants = res.data;
                        if (_this.applicants.length == 0)
                            _this.noApplicantsFlag = true;
                    }, function (err) {
                        _this.httpErr = true;
                        _this.httpErrMsg = err.error.message;
                    });
                };
                PostedJobsComponent.prototype.pageChange = function () {
                    this.getPostedJobs();
                };
                return PostedJobsComponent;
            }());
            PostedJobsComponent.ctorParameters = function () { return [
                { type: _Services_jobs_jobs_service__WEBPACK_IMPORTED_MODULE_2__["JobService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ForgotPasswordComponent = /** @class */ (function () {
                ...
                ForgotPasswordComponent.prototype.Verify = function (email) {
                    var _this = this;
                    this.verify.email = email;
                    this.errMsg = false;
                    this.userService.userVerifyEmail(this.verify).subscribe(function (data) {
                        _this.verifyContainer = false;
                        _this.resetContainer = true;
                        _this.successMsgOtp = true;
                ...
                ForgotPasswordComponent.prototype.Reset = function (otp, newPassword, ConfPassword) {
                    var _this = this;
                    this.reset.otp = otp;
                    this.reset.new_password = newPassword;
                    if (newPassword == ConfPassword) {
                        this.userService.userResetPassword(this.reset).subscribe(function (data) {
                            _this.errMsg = true;
                            _this.message = data.data;
                            _this.errResetMsg = false;
                        }, function (err) {
                            _this.errResetMsg = true;
                            _this.successMsgOtp = false;
                            _this.invalidmsg = err.error.message;
                        });
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.Authenticate = function (email, password) {
                    var _this = this;
                    this.errmsg = false;
                    this.userModel.email = email;
                    this.userModel.password = password;
                    this.userService.userAuthentication(this.userModel).subscribe(function (res) {
                        localStorage.setItem("userData", JSON.stringify(res.data));
                        if (res.data.role_id == 2)
                            _this.router.navigate(['/jobs']);
                        else if (res.data.role_id == 3)
                            _this.router.navigate(['jobs/new']);
                        else {
                            _this.errmsg = true;
                            _this.message = "Please login through ADMIN panel";
                        }
                    }, function (err) {
                        _this.errmsg = true;
                        _this.message = err.error.message;
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.register = function (value) {
                    ...
                    if (this.userModel.role_id != 0) {
                        this.userService.userRegistration(this.userModel).subscribe(function (res) {
                            localStorage.setItem("userData", JSON.stringify(res.data));
                            if (res.data.role_id == 2)
                                _this.router.navigate(['/jobs']);
                            else
                            ...
                            if (err.error.code = 422) {
                                _this.errmsgemail = true;
                                _this.message = err.error.errors.email[0];
                            }
                            else {
                                _this.message = err.error.message;
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var PostJobModel = /** @class */ (function () {
                function PostJobModel() {
                }
                return PostJobModel;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobService = /** @class */ (function () {
                ...
                JobService.prototype.availableJobs = function (page) {
                    this.user = JSON.parse(localStorage.getItem("userData"));
                    this.httpOptions = {
                ...
                JobService.prototype.apply = function (uuid) {
                    this.user = JSON.parse(localStorage.getItem("userData"));
                    this.httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Cache-Control': 'no-cache',
                ...
                JobService.prototype.getAppliedJobs = function (page) {
                    this.user = JSON.parse(localStorage.getItem("userData"));
                    this.httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Cache-Control': 'no-cache',
                ...
                JobService.prototype.postJob = function (newJob) {
                    this.user = JSON.parse(localStorage.getItem("userData"));
                    this.httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Cache-Control': 'no-cache',
                ...
                JobService.prototype.getPostedJobs = function (page) {
                    this.user = JSON.parse(localStorage.getItem("userData"));
                    this.httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Cache-Control': 'no-cache',
                ...
                JobService.prototype.getApplicants = function (uuid) {
                    this.user = JSON.parse(localStorage.getItem("userData"));
                    this.httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Cache-Control': 'no-cache',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.userRegistration = function (user) {
                ...
                UserService.prototype.userAuthentication = function (auth) {
                ...
                UserService.prototype.userVerifyEmail = function (verify) {
                ...
                UserService.prototype.userResetPassword = function (reset) {
